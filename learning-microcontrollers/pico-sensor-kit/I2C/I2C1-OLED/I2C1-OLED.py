...
class OLED_1inch5(framebuf.FrameBuffer):
    def __init__(self,i2c_num=1,i2c_scl=7,i2c_sda=6,i2c_freq=400_000):
...
if __name__=='__main__':
    ...
    for i in range(2,32,2):
        ...
        OLED.fill_rect(0, 70,127,80,  6+i)
        OLED.fill_rect(0, 80,127,90,  8+i)
        OLED.fill_rect(0, 90,127,100, 10+i)
        OLED.fill_rect(0,100,127,110, 12+i)
        OLED.fill_rect(0,110,127,120, 14+i)
        OLED.fill_rect(0,120,127,128, 16+i)
        OLED.show()
        time.sleep(1)
